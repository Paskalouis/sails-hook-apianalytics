        ...
        onResponse: function (report/*, req, res*/) {
          ...
          try {
            ...
            var indentation = (function () {
              var numChars = report.method.length + (report.path ? report.path.length : report.diagnostic.url.length) + moment(now).format('DD-MM-YYYY HH:mm:ss ZZ').length;
              var MARGIN = 80;
            ...
            var displayDate = chalk[getHttpMethodColor(report.method)]('(' + moment(now).format('DD-MM-YYYY HH:mm:ss ZZ') + ')');
